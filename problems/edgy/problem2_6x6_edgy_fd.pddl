; Title: FlowFree Problem2-6x6 (Edgy Strategy)
; Author: Aditi Basu
...
(define (problem FlowFree-6x6)
    ...
    (:init
        ; head relations
        (head node1-6 b) (head node2-6 r)
        (head node5-5 y) 
        (head node2-3 g)

        ; filled relations
        ; the 'starting' positions
        (filled node1-6 b) (filled node2-6 r)
        (filled node5-5 y) 
        (filled node2-3 g)
        ; the 'destinations'
        (filled node2-5 b)
        (filled node1-4 y) (filled node2-4 r)
        (filled node1-1 g)
        ...
        ; pipe relations
        (pipe node1-6 b) (pipe node2-6 r)
        (pipe node5-5 y) 
        (pipe node2-3 g)
        (pipe node2-5 b)
        (pipe node1-4 y) (pipe node2-4 r)
        (pipe node1-1 g)
    ...
    (:goal (and
        ;head relations
        (head node2-5 b)
        (head node1-4 y) (head node2-4 r)
        (head node1-1 g)
        
        ; pipe relations - CHANGE THIS NEXT!
        (pipe node3-6) (pipe node4-6) (pipe node5-6) (pipe node6-6)
        (pipe node1-5) (pipe node3-5) (pipe node4-5) (pipe node6-5)
        (pipe node3-4) (pipe node4-4) (pipe node5-4) (pipe node6-4)
        (pipe node1-3) (pipe node3-3) (pipe node4-3) (pipe node5-3) (pipe node6-3)
        (pipe node1-2) (pipe node2-2) (pipe node3-2) (pipe node4-2) (pipe node5-2) (pipe node6-2)
        (pipe node2-1) (pipe node3-1) (pipe node4-1) (pipe node5-1) (pipe node6-1)
        )
    )
